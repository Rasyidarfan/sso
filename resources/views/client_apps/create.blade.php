...
@section('title', 'Tambah Aplikasi - SSO BPS')
...
<div class="row justify-content-center">
    <div class="col-lg-8">
        <div class="card">
            <div class="card-body">
                <h4 class="card-title mb-4">Tambah Aplikasi Baru</h4>
                
                <form method="POST" action="{{ route('client-apps.store') }}">
                    @csrf
                    ...
                    <div class="mb-3">
                        ...
                        <input type="url" class="form-control @error('redirect_uri') is-invalid @enderror" id="redirect_uri" name="redirect_uri" value="{{ old('redirect_uri') }}" placeholder="https://your-app.domain.com/callback" required>
